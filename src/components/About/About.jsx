                    ...
                    <div className={styles.about_con}>
                        ...
                        <div className={styles.about_info}>
                            ...
                            <div className={styles.text_2}>
                                <h2>การศึกษา</h2>
                                <ul>
                                    <h3>สำเร็จการศึกษาระดับอาชีวศึกษา วิทยาลัยเทคนิคลพบุรี <span>( ปีการศึกษา 2561 )</span></h3>
                                    <li>ประเภทวิชาช่างอุตสาหกรรม</li>
                                    <li>แผนกช่างไฟฟ้า</li>
                                    <li>GPA : 3.45</li>

                                    <h3>เข้าศึกษาในระดับปริญญาตรี มหาวิทยาลัยกรุงเทพ <span>( ปีการศึกษา 2562 - 2564 )</span></h3>
                                    <li>คณะวิศวกรรมศาสตร์</li>
                                    <li>สาขาวิชาวิศวกรรมไฟฟ้า</li>
                                    <li>GPA : 3.95 <span>( ก่อนย้ายคณะ )</span></li>

                                    <h3>กำลังศึกษาอยู่ในระดับปริญญาตรี มหาวิทยาลัยกรุงเทพ <span>( ปัจจุบัน )</span></h3>
                                    <li>คณะวิศวกรรมศาสตร์</li>
