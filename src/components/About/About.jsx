                    ...
                    <div className={styles.about_con}>
                        ...
                        <div className={styles.about_info}>
                            <div className={styles.text_1}>
                                ...
                                <h2>คติที่ชอบ</h2>
                                <blockquote>
                                    <div><q> เปลี่ยนสิ่งที่ไม่รู้เป็นความรู้ <br />แล้วเปลี่ยนความรู้เป็นพลัง </q></div>
                                </blockquote>
                            </div>
                            <div className={styles.text_2}>
                                <h2>การศึกษา</h2>
                                <ul>
                                    <h3><span>สำเร็จการศึกษา</span>ระดับอาชีวศึกษา วิทยาลัยเทคนิคลพบุรี <span>( ปีการศึกษา 2561 )</span></h3>
                                    <li>ประเภทวิชาช่างอุตสาหกรรม</li>
                                    <li>แผนกช่างไฟฟ้า</li>
                                    <li>GPA : 3.45</li>

                                    <h3><span>เข้าศึกษา</span>ในระดับปริญญาตรี มหาวิทยาลัยกรุงเทพ <span>( ปีการศึกษา 2562 - 2564 )</span></h3>
                                    <li>คณะวิศวกรรมศาสตร์</li>
                                    <li>สาขาวิชาวิศวกรรมไฟฟ้า</li>
                                    <li>GPA : 3.95 <span>( ก่อนย้ายคณะ )</span></li>

                                    <h3><span>กำลังศึกษา</span>อยู่ในระดับปริญญาตรี มหาวิทยาลัยกรุงเทพ <span>( ปัจจุบัน )</span></h3>
                                    <li>คณะวิศวกรรมศาสตร์</li>
